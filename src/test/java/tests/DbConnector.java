...
public class DbConnector {
    ...
    public static void importSakilaDatabase() throws IOException, SQLException {
        try (
                final var worldInputStream = DbConnector.class.getResourceAsStream(H2_DB_FILE);
                final var connection = DriverManager.getConnection(DB_CONNECTION.getValue(), DB_USER.getValue(),
